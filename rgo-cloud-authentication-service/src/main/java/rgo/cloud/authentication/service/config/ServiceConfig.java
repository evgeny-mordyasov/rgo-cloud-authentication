...
public class ServiceConfig {
    ...
    @Bean
    public ClientEntryFailedService clientEntryFailedService(ClientEntryFailedRepository clientEntryFailedRepository,
                                                             ClientEntryFailedProperties config) {
        return new ClientEntryFailedService(clientEntryFailedRepository, config);
    }
}
